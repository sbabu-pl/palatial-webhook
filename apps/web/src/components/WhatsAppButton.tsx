...
export default function WhatsAppButton() {
  const botNumber = "254722606608"; 
  const defaultMessage = encodeURIComponent("Hi Palatial, I need help with insurance from the website.");
  const waLink = `https://wa.me/${botNumber}?text=${defaultMessage}`;
